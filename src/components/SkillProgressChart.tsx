...
export function SkillProgressChart({ data }: SkillProgressChartProps) {
    ...
    return (
        <Card className="border-border/40 shadow-xl shadow-emerald-500/5 bg-card/50 backdrop-blur-xl rounded-3xl h-full overflow-hidden hover:shadow-2xl hover:shadow-emerald-500/10 transition-all duration-500 group">
                        ...
                        <RadarChart cx="50%" cy="50%" outerRadius="70%" data={chartData}>
                            <defs>
                                <radialGradient id="radarFill" cx="0.5" cy="0.5" r="0.5">
                                    ...
                                    <stop offset="100%" stopColor="hsl(var(--emerald-500))" stopOpacity={0.1} />
                                </radialGradient>
                            </defs>
                            ...
                            <Tooltip
                                ...
                                itemStyle={{ color: 'hsl(var(--emerald-600))' }}
                            />
                        </RadarChart>
                    </ResponsiveContainer>
                </div>
