...
import { Mail, Lock, User, Building2, Eye, EyeOff, Upload, ArrowRight, X, Sparkles } from "lucide-react";
...
function RecruiterAuthContent() {
    ...
    const testimonials = [
        {
            quote: "Reduced our time-to-hire by 60% while significantly improving candidate quality with AI screening.",
            author: "Sarah Chen",
            role: "VP of Talent at TechFlow"
        },
        {
            quote: "The automated interview summaries save me hours every week. A must-have tool for modern recruiting.",
            author: "David Miller",
            role: "Head of HR, Innovate Inc."
        },
        {
            quote: "Unbiased, data-driven hiring decisions made easy. Arjuna Recruit transformed how we build teams.",
            author: "Emily Zhang",
    ...
    if (loading && !user) {
        return <div className="min-h-screen bg-slate-950 flex items-center justify-center"><PremiumLogoLoader text="Initializing Recruiter Portal..." /></div>;
    }
    ...
    return (
        ...
        >
            ...
            <div className="hidden lg:flex relative flex-col justify-between p-12 bg-indigo-950 border-r border-white/5 overflow-hidden">
                {/* Background Image with Overlay */}
                <div className="absolute inset-0 z-0">
                    <Image
                        src="/images/recruiter-sidebar.png"
                        alt="Arjuna Recruit Background"
                        fill
                        className="object-cover opacity-90 scale-105"
                        priority
                    />
                    <div className="absolute inset-0 bg-gradient-to-tr from-indigo-950/80 via-indigo-900/40 to-purple-900/20" />
                    <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-transparent via-indigo-950/30 to-indigo-950/80" />
                </div>
                ...
                <div className="relative z-10">
                    <Link href="/" className="inline-flex items-center gap-3 group">
                        <div className="relative">
                            ...
                            <Image src="/arjuna_logo.png" alt="Arjuna AI" width={48} height={48} className="relative object-contain drop-shadow-lg" />
                        </div>
                        <span className="text-2xl font-black tracking-tight text-white drop-shadow-md">ARJUNA RECRUIT</span>
                    </Link>
                </div>
                ...
                <div className="relative z-10 max-w-md">
                    <h2 className="text-4xl font-extrabold text-white mb-6 leading-tight drop-shadow-lg">
                        Hire Smarter.<br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-200 to-purple-200">Scale without limits.</span>
                    </h2>
            ...
            <div className="relative flex flex-col items-center justify-center p-4 sm:p-12 overflow-y-auto bg-white min-h-screen lg:min-h-0">
                ...
                <div className="absolute top-6 left-6 lg:hidden">
                    <Link href="/" className="inline-flex items-center gap-2">
                        ...
                        <span className="text-lg font-black text-slate-900">ARJUNA RECRUIT</span>
                    </Link>
                </div>
                ...
                >
                    <div className="space-y-2 text-center lg:text-left mt-16 lg:mt-0">
                        ...
                        <p className="text-slate-500 text-base">
                            {isSignUp ? "Streamline your hiring process today." : "Welcome back to your hiring dashboard."}
                        </p>
                    </div>
                    ...
                    <div className="grid gap-6">
                                    ...
                                    <Form {...signUpForm}>
                                        <form onSubmit={signUpForm.handleSubmit(handleSignUp)} className="space-y-5">
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        <Label className="text-slate-500 text-xs font-bold uppercase tracking-wider ml-1">Company / Organization</Label>
                                                        <div className="relative">
                                                            <Building2 className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400" />
                                                            <FormControl>
                                                                <Input placeholder="Acme Inc." {...field} className="h-12 pl-10 bg-slate-50 border-slate-100 hover:border-slate-200 focus:bg-white focus:border-indigo-500 rounded-xl text-slate-900 font-medium placeholder:text-slate-400" />
                                                            </FormControl>
                                                        </div>
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        ...
                                                        <div className="relative">
                                                            ...
                                                            <FormControl>
                                                                <Input placeholder="John Doe" {...field} className="h-12 pl-10 bg-slate-50 border-slate-100 hover:border-slate-200 focus:bg-white focus:border-indigo-500 rounded-xl text-slate-900 font-medium placeholder:text-slate-400" />
                                                            </FormControl>
                                                        </div>
                                                        <FormMessage className="text-[10px] text-red-500 pl-1" />
                                                    </FormItem>
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        <Label className="text-slate-500 text-xs font-bold uppercase tracking-wider ml-1">Work Email</Label>
                                                        <div className="relative">
                                                            <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400" />
                                                            <FormControl>
                                                                <Input placeholder="recruiter@company.com" {...field} className="h-12 pl-10 bg-slate-50 border-slate-100 hover:border-slate-200 focus:bg-white focus:border-indigo-500 rounded-xl text-slate-900 font-medium placeholder:text-slate-400" />
                                                            </FormControl>
                                                        </div>
                                                        <FormMessage className="text-[10px] text-red-500 pl-1" />
                                                    </FormItem>
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        ...
                                                        <div className="relative">
                                                            ...
                                                            <FormControl>
                                                                <Input type={showPassword ? "text" : "password"} placeholder="Create a strong password" {...field} className="h-12 pl-10 bg-slate-50 border-slate-100 hover:border-slate-200 focus:bg-white focus:border-indigo-500 rounded-xl text-slate-900 font-medium placeholder:text-slate-400 pr-10" />
                                                            </FormControl>
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        ...
                                                        <div className="relative">
                                                            <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400" />
                                                            <FormControl>
                                                                <Input type={showPassword ? "text" : "password"} placeholder="Enter your password" {...field} className="h-12 pl-10 bg-slate-50 border-slate-100 hover:border-slate-200 focus:bg-white focus:border-indigo-500 rounded-xl text-slate-900 font-medium placeholder:text-slate-400 pr-10" />
                                                            </FormControl>
                                                            <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 transition-colors">
                                                                {showPassword ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
                                                            </button>
                        ...
                        <Button variant="outline" type="button" onClick={handleGoogleSignIn} className="w-full h-12 bg-white border-slate-100 hover:bg-slate-50 text-slate-700 font-bold rounded-xl flex items-center justify-center gap-2 transition-all">
...
export default function RecruiterAuth() {
    return (
        <Suspense fallback={<div className="min-h-screen bg-slate-950 flex items-center justify-center"><PremiumLogoLoader text="Loading..." /></div>}>
