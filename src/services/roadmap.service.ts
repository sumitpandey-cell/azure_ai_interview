...
class RoadmapService {
    ...
    async generateRoadmap(
        ...
        try {
            ...
            const overallLevel = (level as any) || this.calculateOverallLevel(history);
     ...
     */
    private buildAnalysisPrompt(history: any, domain?: string, role?: string, level?: string): string {
...
` : '';
        ...
        const historyContext = history.completed.length > 0 ? `
...
Return ONLY valid JSON, no markdown formatting, no code blocks, just the raw JSON object.`;
     ...
     */
    async refreshRoadmap(userId: string, paymentId?: string, supabaseClient?: any, domain?: string, role?: string, level?: string) {
