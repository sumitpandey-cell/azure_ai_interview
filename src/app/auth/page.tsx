                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                            <Button
                                variant="outline"
                                type="button"
                                className="w-full h-11 sm:h-12 border border-white/10 bg-white/5 hover:bg-white/10 transition-all rounded-xl flex items-center justify-center gap-3 group"
