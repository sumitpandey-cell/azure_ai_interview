...
export default function StartInterview() {
    ...
    useEffect(() => {
        const loadCompanies = async () => {
            ...
            // Check if there's a companyId in URL params and set the template
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        ...
        try {
            ...
            if (values.interviewMode === 'company' && values.companyId) {
                ...
                config.companyId = values.companyId;
                config.companyName = selectedCompany?.name;
                config.role = values.role;
            }
